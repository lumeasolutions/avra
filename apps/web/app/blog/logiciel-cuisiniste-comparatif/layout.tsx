...
export const metadata: Metadata = {
  ...
  description: 'Comparatif independant des principaux logiciels de gestion pour cuisinistes en 2026 : AVRA, WinnerFlex, KitchenDraw, Optimea, ProgeCAD. Prix, IA, e-facture, support.',
