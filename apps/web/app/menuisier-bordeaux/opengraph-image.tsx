...
export const alt = 'AVRA — Logiciel pour Menuisiers Bordeaux';
export const size = { width: 1200, height: 630 };
export const contentType = 'image/png';

/**
 * OpenGraph image dynamique pour la page geo /menuisier-bordeaux.
