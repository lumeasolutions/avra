      ...
      <div style={{ background: '#ffffff', color: '#1e2b22', minHeight: '100vh', fontFamily: 'var(--font-dm-sans, "DM Sans"), system-ui, sans-serif' }}>
        <div className="legal-wrap">
          ...
          <section style={{ marginBottom: 50 }}>
            ...
            <p style={{ fontSize: 16, marginBottom: 0 }}>
              Les tarifs et plans disponibles sont présentés sur le site https://avra-app.fr. Ils peuvent être modifiés à tout moment par le Prestataire après notification préalable.
            </p>
          </section>
