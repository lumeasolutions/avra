...
export const metadata: Metadata = {
  title: "Toutes les fonctionnalités d'AVRA, module par module",
  description:
    "Dossiers, devis, facturation e-facture 2026, planning, stock, signature électronique, rendus IA, statistiques : les 8 modules en détail.",
...
const jsonLd = {
  ...
  featureList: [
    ...
    'Pipeline CRM visuel',
    'Gestion et coordination des intervenants',
  ],
  offers: {
    '@type': 'Offer',
    price: '49',
...
const features = [
  {
    ...
    features: [
      ...
      'Vos dossiers accessibles et partageables en un clic',
      'Dossiers mieux organisés grâce à une trame structurée',
      'Tableau de bord intégré à chaque dossier',
      "Zéro oubli avec l'assistant IA",
      'Anticipez vos commandes avec des dates clés',
    ],
    badge: 'Essentiel',
  ...
  },
  {
    ...
    features: [
      "Votre module de facturation au sein d'AVRA",
      'Offrez un accès direct à votre comptable',
      'Gardez un œil sur vos alertes depuis votre module de facturation',
      'Accédez aux statistiques de vos ventes une fois la facture créée',
      'Passez facilement de la facturation au e-paiement et à la e-signature',
      "Enregistrez vos factures dans le dossier administratif AVRA",
    ],
    badge: 'Populaire',
  ...
  },
  {
    ...
    features: [
      ...
      'Importez une texture pour changer le coloris des façades',
    ],
    badge: 'IA',
  ...
  },
  {
    ...
    features: [
      ...
      'Créez et suivez vos invitations de chantier',
      'Export planning PDF',
    ],
    badge: 'Pro',
  ...
  },
  {
    ...
    features: [
      'Stock en temps réel',
      'Alertes de rupture',
      'Stockage intelligent et intuitif',
      'Visualisez les disponibilités grâce aux codes couleurs',
      'Image associée à chaque produit avec sa référence',
      'Exportez vos données en Excel pour votre comptable',
    ],
    badge: 'Pro',
  ...
  },
  {
    id: 'stats',
    icon: BarChart3,
    title: 'Gestion et coordination des intervenants',
    ...
    features: [
      'Partagez des dossiers spécifiques avec vos intervenants',
      'Faites des demandes spécifiques à vos artisans (devis, planning, SAV…)',
      'Recevez messages et documents directement de vos intervenants',
      "L'assistant IA AVRA suit vos demandes et relance les artisans",
      'Visualisez les alertes par intervenant',
      'Fini les échanges perdus entre mails et SMS',
    ],
    badge: 'Pro',
