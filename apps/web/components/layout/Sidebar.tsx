...
export function Sidebar() {
  ...
  return (
    <div className="sidebar">
      ...
      <Link href="/dossiers/nouveau" className="btn-nouveau">
      ...
      <nav className="menu-list">
        ...
        <Link
          ...
          className={`menu-item ${pathname === '/dossiers-signes' ? 'active' : ''}`}
        >
        ...
        <Link
          href="/planning"
          className={`menu-item ${pathname === '/planning' ? 'active' : ''}`}
        >
        ...
        <Link
          href="/planning-gestion"
          className={`menu-item ${pathname === '/planning-gestion' ? 'active' : ''}`}
        >
        ...
        <Link
          href="/stock"
          className={`menu-item ${pathname === '/stock' ? 'active' : ''}`}
        >
        ...
        <Link
          href="/admin-docs"
          className={`menu-item ${pathname === '/admin-docs' ? 'active' : ''}`}
        >
        ...
        <Link
          href="/ia-studio"
          className={`menu-item ${pathname === '/ia-studio' ? 'active' : ''}`}
        >
        ...
        <Link
          href="/statistiques"
          className={`menu-item ${pathname === '/statistiques' ? 'active' : ''}`}
        >
          <svg viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M8 17V13"/><path d="M12 17V7"/><path d="M16 17v-4"/></svg>
          Statistiques
        </Link>
        <Link
          href="/facturation"
          className={`menu-item ${pathname === '/facturation' ? 'active' : ''}`}
        >
        ...
        <Link
          href="/intervenants"
          className={`menu-item ${pathname === '/intervenants' ? 'active' : ''}`}
        >
